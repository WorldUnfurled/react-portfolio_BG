...
export default function Work() {
    return (
        <div id="work">
            ...
            <div className="cards">
                <a href='https://worldunfurled.github.io/project-1_RDB/' target="_blank">
                    <div className="card card1">
                        <div className="card-container">
                            <img src={coinbased} alt="Project 1: Crypto" className="card-image"/>
                        </div>
                ...
                <a href='https://mysterious-lowlands-06062.herokuapp.com/' target="_blank">
                ...
                <a href='https://worldunfurled.github.io/my-password-generator_BG' target="_blank">
                ...
                <a href='https://github.com/WorldUnfurled/portfolio-website_BG' target="_blank">
                ...
                <a href='https://github.com/WorldUnfurled/ecommerce-backend_BG' target="_blank">
